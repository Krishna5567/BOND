// The path rules for the bond-doc:// scheme, kept pure so they can be tested
...
// A bond-doc URL is  bond-doc://doc/<root>/<rel>  where both parts are
...
function parseDocUrl(urlString) {
  ...
  if ((u.protocol !== 'bond-doc:' && u.protocol !== 'nami-doc:') || u.host !== 'doc') return null;
