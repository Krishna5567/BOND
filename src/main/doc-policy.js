// 'self' alone covers every encoded root on bond-doc://doc. Restrict resource
...
function documentPolicy(root) {
  ...
  const source = `bond-doc://doc/${encoded}/ nami-doc://doc/${encoded}/`;
  return `default-src ${source} data: blob:; img-src ${source} data: blob:; `
    ...
    + `object-src 'none'; base-uri bond-doc://doc/${encoded}/ nami-doc://doc/${encoded}/; form-action 'none';`;
}
